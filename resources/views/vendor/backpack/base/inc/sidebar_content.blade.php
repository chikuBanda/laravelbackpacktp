...
<li class='nav-item'><a class='nav-link' href='{{ backpack_url('elem_produit') }}'><i class='nav-icon fa fa-question'></i> Elem_produits</a></li> --}}
...
{{-- <li class='nav-item'><a class='nav-link' href='{{ backpack_url('favori') }}'><i class='nav-icon fa fa-question'></i> Favoris</a></li> --}}
