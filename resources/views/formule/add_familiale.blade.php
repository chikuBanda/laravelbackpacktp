                    ...
                    <div class="row" style="padding-left: 140px">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <input value="8 chicken wings" name="chicken_wings" class="form-control" id="chicken_wings" hidden>
                            </div>
                        </div>

                        <div class="col-md-6 form-group">
                            <label for="grand_boisson">Boisson</label>
                            <select style="width: 70%" class="form-control" id="grand_boisson" name="grand_boisson">
                                @foreach ($produits as $produit)
